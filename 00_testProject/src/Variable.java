public class Variable {
	...
	public static void main(String[] args) {
		// int(정수)라는 자료형으로 num라는 이름의 변수 선언
		// int num;
		
		//boolean(참과 거짓)이라는 자료형으로 isTrue라는 이름의 변수 선언
		
		//boolean isTrue;
		// float(실수)이라는 자료형으로 num2라는 이름의 변수 선언
		//float num20;
		//syso에 Ctrl+스페이스를 입력하면 System.out.println();가 자동완성
		...
		float fl = 4.24f; //f는 보이진 않지만 실제로 존재하는 실수의 0 부분을 잘라내고 자료형이 float라는 것을 명시하기 위함
		double dou = 4.24;
		 ...
		 */
		System.out.println("저는 이렇게 말했습니다. \"배가 고픕니다.\"");
		System.out.print("저는\n지금\n배가 고파요");
		 ...
		 * 이름이 둘 이상의 단어로 이뤄질 경우, 언더바로 연결한다 ex)MY_AGE
		 */
		
		final int AGE;
		AGE = 90;
		// AGE = 10을 입력하면 오류가 발생한다. 한 번 값을 초기화하면 더이상 변결할 수 없다.
