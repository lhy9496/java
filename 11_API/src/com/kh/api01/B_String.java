...
public class B_String {
	...
	public void method01() {
		...
		//String 클래스에 equals메소드는 이미 오버라이딩 되어 있음(주소값 비교가 아닌 담긴 문자열을 비교하도록)
		
		System.out.println(str1.hashCode());
		System.out.println(str2.hashCode());
		//String 클래스 hashcode 메소드도 이미 오버라이덩 되어 있음(주소값이 아닌 문자열을 가지고 만들도록)
		
		//주소값에 대한 해시코드는 identityHashCode 메소드를 이용해야 한다.
		...
		// 변경이 가능하지만 수정되는 개념이 아닌, 새로 생성하여 교체하는 개념
	...
	public void method02() {
		...
		//    문자열과 전달된 또다른 문자열로 주소값이 아닌 실제 문자열 값을 동등 비교
		System.out.println("str2와 str3는 일치하는가 : " + str2.equals(str3));
		
		// 4. 문자열.contains(CharSequence s) : boolean
		System.out.println("str1에 Hello라는 문자열이 포함되어 있는가? : " + str1.contains("Hello"));
		System.out.println("str1에 Bye라는 문자열이 포함되어 있는가? : " + str1.contains("Bye"));
		...
		//    문자열에서 oldChar에 해당하는 문자를 newChar문자로 변환한 새 문자열 리턴
		String str4 = str1.replace('l', 'c');
		System.out.println("str4 : " + str4);
		System.out.println("str1 : " + str1);
		
		// 8. 문자열.toUpperCase() : String => 문자열을 전부 대문자로 변경한 새 문자열 리턴
		//    문자열.toLowerCase() : String => 문자열을 전부 소문자로 변경한 새 문자열 리턴
...
//		}
	...
	public void method03() {
		...
		*/
		...
		//토큰을 꺼낼 때마다 토큰이 줄어들며, 토큰이 하나도 없는 상태에서 nextToken()을 쓰면 에러 발생
