...
//		System.out.println(dArr);
		 ...
		 * 
		 * 기본자료형(boolean, int, char, byte, long, doulble등등)으로 선언된 변수
		...
		/*
		 * 연결이 끊어진 기존 배열은 Heap영역에 둥둥 떠다님
		 * = 어디에도 참조되어 있지 않아 사용되지 않음 => 필요없는 존재
		...
		int[] arr3 = {1, 2, 3, 4}; // 표현법2(new int[] 생략
		int[] arr4 = arr3;//
